...
Namespace SpreadsheetSpellchecking_WPF
    ...
    Public Class SpreadsheetSpellChecker
        ...
        Private Sub UnsubscribeFromEvents()
            RemoveHandler Me.Spreadsheet.CellEditorOpened, AddressOf OnSpreadsheet_CellEditorOpened
            RemoveHandler SpellChecker.CheckCompleteFormShowing, AddressOf OnChecker_CheckCompleteFormShowing
        End Sub
